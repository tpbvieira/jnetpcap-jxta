...
public class JxtaStatistics {
	...
	public static void main(String[] args) {
		...
		final String FILENAME = "/home/thiago/tmp/pcap-traces/jxta-socket/simpleSocket/client/1MB/client.1.03.1024.pcap";
		//		final String FILENAME = "/home/thiago/tmp/pcap-traces/jxta-socket/simpleSocket/client/1MB/client.1.3.1024.pcap";
		//		final String FILENAME = "/home/thiago/tmp/pcap-traces/jxta-socket/simpleSocket/client/1MB/client.1.3.1024.pcap1";
		//		final String FILENAME = "/home/thiago/tmp/pcap-traces/jxta-socket/simpleSocket/client/1MB/client.1.3.1024.pcap2";
		//		final String FILENAME = "/home/thiago/tmp/pcap-traces/jxta-socket/simpleSocket/client/1MB/client.1.3.1024.pcap3";
	...
	//	private static long getPacketsMeanTime(ArrayList<JPacket> pkts){
	//		long time = 0;
	//
	//		if(pkts.size() > 1){
		...
		try{			
			...
			if (el != null) {				
				...
				if(el != null){					
					...
					EndpointAddress address = erm.getDestAddress();
					if(address != null){
						String strFlowId = erm.getDestAddress().getServiceParameter();// PipeID
						Integer flowId = Integer.valueOf(strFlowId.hashCode());// Hash code of PipeID
	...
	public static void printFlowStatistics(ArrayList<Jxta> flow){
		double tcpPay = 0;
		double jxtaPay = 0;
	...
	private static void updateAfterDecode(JPacket packet, Jxta jxta){
		jxta.getPackets().add(packet);
		updateSocketFlows(jxta);
		int contentLength = JxtaUtils.getMessageContent(jxta).length;
