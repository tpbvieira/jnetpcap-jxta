...
public class JxtaSocketServerDriver {
	...
	public JxtaSocketServerDriver() throws IOException, PeerGroupException {
	...
	public static void main(String args[]) {
		...
		try {
			Thread.currentThread().setName(JxtaSocketServerDriver.class.getName() + ".main()");
			JxtaSocketServerDriver socEx = new JxtaSocketServerDriver();
			socEx.run();
		} catch (Throwable e) {
			e.printStackTrace();
		}
